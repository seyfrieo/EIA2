...
(function (Aufgabe11) {
    ...
    var basketBaumform = [Aufgabe11.baumArt[0][0], "" + Aufgabe11.baumArt[0][1]];
    var basketNadeln = ["keine Nadelanzahl ausgew�hlt", "0"];
    var basketSchmuck = [];
    ...
    function createElements() {
        ...
        for (var i = 0; i < Aufgabe11.posten.length; i++) {
            if (Aufgabe11.posten[i].art == "Nadeln") {
    ...
    function warenkorb(_event) {
        ...
        for (var i = 0; i < Aufgabe11.posten.length; i++) {
            ...
            if (target.value == Aufgabe11.posten[i].name && target.id == "selectBaumform") {
                basketBaumform[0] = Aufgabe11.posten[i].name; //holt ausgew�hlte assoziative-array-elemente name und preis vom posten
                basketBaumform[1] = "" + Aufgabe11.posten[i].preis;
            }
            if (target.id == "radio" + i) {
                basketNadeln[0] = Aufgabe11.posten[i].name; //holt ausgew�hlte assoziative-array-elemente name und preis vom posten
                basketNadeln[1] = "" + Aufgabe11.posten[i].preis;
            }
            if (target.id == "radio2." + i) {
                basketLieferopt[0] = Aufgabe11.posten[i].name;
                basketLieferopt[1] = "" + Aufgabe11.posten[i].preis; //genau gleiche
            }
