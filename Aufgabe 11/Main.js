...
(function (Aufgabe11) {
    ...
    var basketBaumform = [baumArt[0][0], "" + baumArt[0][1]];
    ...
    function warenkorb(_event) {
        ...
        for (var i = 0; i < posten.length; i++) {
            ...
            if (target.value == posten[i].name && target.id == "selectBaumform") {
                basketBaumform[0] = posten[i].name; //holt ausgew�hlte assoziative-array-elemente name und preis vom posten
                basketBaumform[1] = "" + posten[i].preis;
            }
            if (target.id == "radio" + i) {
                basketNadeln[0] = posten[i].name; //holt ausgew�hlte assoziative-array-elemente name und preis vom posten
